...
fs2_matrix=[0.5, 0.8, 1.1, 1.4]*0.003;
                    ...
                    for ii_fm=1:num_fm
                        ...
                        for ii_offvar=1:num_offvar
                            ...
                            for ii_ksw4=1:num_ksw4
                                ...
                                for ii_sep4=1:num_sep4
                                    sep4_cal=sep4_matrix(ii_sep4);
...
AREX_amp_matrix_S(i) = (fs4.*ksw4.*(tt_4p7T.*42.6*2*pi).^2./((tt_4p7T.*42.6*2*pi).^2+(R2S4+ksw4)*ksw4));
AREX_width_matrix_S(i)=2*sqrt((tt_4p7T.*42.6*2*pi).^2.*(R2S4+ksw4)/ksw4+(ksw4+R2S4)^2);
 % AREX_groundtruth_matrix(:,ii_T1W,ii_T2W, ii_T2S4,ii_T2M, ii_fs2, ii_fs5, ii_fm, ii_ksw4, ii_ksw2, ii_sep4,ii_fs4)=(fs4.*ksw4.*(tt_4p7T.*42.6*2*pi).^2./((tt_4p7T.*42.6*2*pi).^2+(R2S4+ksw4)*ksw4+ksw4./(R2S4+ksw4).*((k_4p7T+sep4)*2*pi).^2));
...
DL_Input_training_clean = R1W_cal_matrix_S./aa_4p7T_S;
